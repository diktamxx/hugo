...
早些年在网上经常可以见到有人争论什么编程语言最好（如今其实也不少见）。作为一名学习了多年 Java 的人来说固然会对其产生一些偏爱。我想其中一个主要原因可能是因为见证着它一直在为适应新的软件环境而作出改变。譬如 Lambda、JPMS、Virtual Threads、Structured Concurrency、GraalVM AOT compilation、JVM CRaC 和 Leyden 等等。但即便如此，我也并不认为 Java 可以很好地胜任所有开发需求。其中一个活生生的例子是就是与 AI 领域相关的开发，显然 Python 和 JavaScript 这些动态语言被优先得到了更好的支持。此外，在并发编程需求场景中 FP 比 OOP 更加安全，此时可以考虑 F#、Clojure、Scala 这类编程语言。
