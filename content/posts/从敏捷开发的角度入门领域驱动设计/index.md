...
### 3.1 敏捷是DDD的基础。若不清楚这一点，则会无法理解和运用好它
...
### 3.2 DDD的价值
DDD其实是**一套解决复杂领域业务问题的方法论（由一系列模式组成）**。
...
它的歧义在于只适用于BC范围之内（，因此有人建议将其称为“模型语言[^7]”）。
